...
func TestSkipLearnHook_FrameworkCommandsSkipped(t *testing.T) {
	cases := []string{
		"zapier-pp-cli auth login",
		"zapier-pp-cli doctor",
		"zapier-pp-cli help items",
		"zapier-pp-cli sync",
		"zapier-pp-cli profile list",
		"zapier-pp-cli feedback list",
		"zapier-pp-cli which",
		"zapier-pp-cli agent-context",
		"zapier-pp-cli completion bash",
...
func TestSkipLearnHook_NovelCommandsNotSkipped(t *testing.T) {
	novel := []string{
		"zapier-pp-cli teach",
		"zapier-pp-cli recall",
		"zapier-pp-cli learnings",
		"zapier-pp-cli teach-pattern",
		"zapier-pp-cli teach-lookup",
		"zapier-pp-cli items list",
	}
