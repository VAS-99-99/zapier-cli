...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  zapier-pp-cli which "stale tickets"
  zapier-pp-cli which "bottleneck"
  zapier-pp-cli which --limit 1 "send message"
  zapier-pp-cli which                                # list the full capability index`,
