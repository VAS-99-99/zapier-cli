...
type rootFlags struct {
	...
	// invocation. Mirrors the ZAPIER_NO_LEARN env var.
	noLearn                 bool
	selectFields            string
	configPath              string
	homePath                string
...
Run 'zapier-pp-cli doctor' to verify auth and connectivity.`,
	...
	rootCmd.SetVersionTemplate("zapier-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.runProfileName, "profile", "", "Apply values from a saved run profile; this does not select a client (see 'zapier-pp-cli profile list')")
