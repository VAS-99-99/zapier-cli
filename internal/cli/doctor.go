...
func newDoctorCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: `  zapier-pp-cli doctor
  zapier-pp-cli doctor --json
  zapier-pp-cli doctor --fail-on warn
  zapier-pp-cli doctor --fail-on stale`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if os.Getenv("ZAPIER_SESSION_COOKIE") != "" {
				authEnvSet = append(authEnvSet, "ZAPIER_SESSION_COOKIE")
				...
				authEnvRequiredMissing = append(authEnvRequiredMissing, "ZAPIER_SESSION_COOKIE")
			}
			switch {
